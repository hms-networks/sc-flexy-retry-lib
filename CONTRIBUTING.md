# Ewon Flexy Automatic Code Retry Library Contribution Guidelines
...
Before asking a question, it is best to search for existing [Issues](https://github.com/hms-networks/sc-flexy-retry-lib/issues) or [Discussions](https://github.com/hms-networks/sc-flexy-retry-lib/discussions) that may help. In case you've found a suitable issue or discussion and still need clarification, you may comment directly on the issue or discussion. It is also advisable to search the internet for answers.

If you then still have a question or need clarification, you may create a [new discussion](https://github.com/hms-networks/sc-flexy-retry-lib/discussions/new) or [new issue](https://github.com/hms-networks/sc-flexy-retry-lib/issues/new) and provide as much context and detail as possible.
...
We use GitHub issues to track bugs and errors. If you run into an issue with the project, please create a [new issue](https://github.com/hms-networks/sc-flexy-retry-lib/issues/new) with the following in consideration:
...
We use GitHub issues to track feature and enhancement requests. If you'd like to suggest a feature or enhancement, please create a [new issue](https://github.com/hms-networks/sc-flexy-retry-lib/issues/new) with the following in consideration:
...
- Perform a search for existing [Issues](https://github.com/{APPLICATION NAME}/issues) or [Discussions](https://github.com/hms-networks/sc-flexy-retry-lib/discussions) to see if the feature or enhancement has already been suggested. 
